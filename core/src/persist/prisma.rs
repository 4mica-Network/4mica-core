...
pub mod user {
    ...
    pub mod revenue {
        ...
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::Revenue(direction)
        }
        pub fn equals(value: f64) -> WhereParam {
            WhereParam::Revenue(_prisma::read_filters::FloatFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::FloatFilter,
            Revenue,
        ...
        pub fn increment(value: f64) -> SetParam {
            SetParam::IncrementRevenue(value)
        }
        pub fn decrement(value: f64) -> SetParam {
            SetParam::DecrementRevenue(value)
        }
        pub fn multiply(value: f64) -> SetParam {
            SetParam::MultiplyRevenue(value)
        }
        pub fn divide(value: f64) -> SetParam {
            SetParam::DivideRevenue(value)
        }
        pub struct Include;
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::Revenue(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
        ...
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::Revenue(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::Revenue(data) => data.to_selection(),
    ...
    #[macro_export]
    macro_rules ! _include_user { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: user :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: user :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: user :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: user :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: user :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: user :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: user :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: user :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { transactions } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub address : String , pub deposit : f64 , pub revenue : f64 , pub version : i32 , pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , pub updated_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , $ (pub $ field : crate :: prisma :: user :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (address) , stringify ! (deposit) , stringify ! (revenue) , stringify ! (version) , stringify ! (created_at) , stringify ! (updated_at)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: user :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: user :: address :: NAME , & self . address) ? ; state . serialize_field (crate :: prisma :: user :: deposit :: NAME , & self . deposit) ? ; state . serialize_field (crate :: prisma :: user :: revenue :: NAME , & self . revenue) ? ; state . serialize_field (crate :: prisma :: user :: version :: NAME , & self . version) ? ; state . serialize_field (crate :: prisma :: user :: created_at :: NAME , & self . created_at) ? ; state . serialize_field (crate :: prisma :: user :: updated_at :: NAME , & self . updated_at) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , address , deposit , revenue , version , created_at , updated_at } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: user :: $ field :: NAME) , + , crate :: prisma :: user :: address :: NAME , crate :: prisma :: user :: deposit :: NAME , crate :: prisma :: user :: revenue :: NAME , crate :: prisma :: user :: version :: NAME , crate :: prisma :: user :: created_at :: NAME , crate :: prisma :: user :: updated_at :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: user :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: user :: address :: NAME => Ok (Field :: address) , crate :: prisma :: user :: deposit :: NAME => Ok (Field :: deposit) , crate :: prisma :: user :: revenue :: NAME => Ok (Field :: revenue) , crate :: prisma :: user :: version :: NAME => Ok (Field :: version) , crate :: prisma :: user :: created_at :: NAME => Ok (Field :: created_at) , crate :: prisma :: user :: updated_at :: NAME => Ok (Field :: updated_at) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut address = None ; let mut deposit = None ; let mut revenue = None ; let mut version = None ; let mut created_at = None ; let mut updated_at = None ; while let Some (key) = map . next_key () ? { match key { Field :: address => { if address . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: address :: NAME)) ; } address = Some (map . next_value () ?) ; } Field :: deposit => { if deposit . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: deposit :: NAME)) ; } deposit = Some (map . next_value () ?) ; } Field :: revenue => { if revenue . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: revenue :: NAME)) ; } revenue = Some (map . next_value () ?) ; } Field :: version => { if version . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: version :: NAME)) ; } version = Some (map . next_value () ?) ; } Field :: created_at => { if created_at . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: created_at :: NAME)) ; } created_at = Some (map . next_value () ?) ; } Field :: updated_at => { if updated_at . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: updated_at :: NAME)) ; } updated_at = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: $ field :: NAME)) ? ;) * let address = address . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: address :: NAME)) ? ; let deposit = deposit . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: deposit :: NAME)) ? ; let revenue = revenue . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: revenue :: NAME)) ? ; let version = version . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: version :: NAME)) ? ; let created_at = created_at . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: created_at :: NAME)) ? ; let updated_at = updated_at . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user :: updated_at :: NAME)) ? ; Ok (Data { address , deposit , revenue , version , created_at , updated_at , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["address" , "deposit" , "revenue" , "version" , "created_at" , "updated_at" , "transactions"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: user :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; transactions : $ selection_mode : ident { $ ($ selections : tt) + }) => { Vec < transactions :: Data > } ; (@ field_type ; transactions) => { Vec < crate :: prisma :: user_transaction :: Data > } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "User" , available relations are "transactions")) } ; (@ field_module ; transactions : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: user_transaction :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; transactions $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: user :: IncludeParam > :: into (crate :: prisma :: user :: transactions :: Include :: $ selection_mode (crate :: prisma :: user_transaction :: ManyArgs :: new (crate :: prisma :: user_transaction :: include ! (@ filters_to_args ; $ ($ ($ filters) +) ?)) $ ($ (. $ arg ($ ($ arg_params) *)) *) ? , crate :: prisma :: user_transaction :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; transactions $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: user :: IncludeParam > :: into (crate :: prisma :: user :: transactions :: Include :: Fetch (crate :: prisma :: user_transaction :: ManyArgs :: new (crate :: prisma :: user_transaction :: include ! (@ filters_to_args ; $ ($ ($ filters) +) ?)) $ ($ (. $ arg ($ ($ arg_params) *)) *) ?) ,) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: user :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; address) => { "address" } ; (@ field_serde_name ; deposit) => { "deposit" } ; (@ field_serde_name ; revenue) => { "revenue" } ; (@ field_serde_name ; version) => { "version" } ; (@ field_serde_name ; created_at) => { "created_at" } ; (@ field_serde_name ; updated_at) => { "updated_at" } ; (@ field_serde_name ; transactions) => { "transactions" } ; }
    pub use _include_user as include;
    pub enum IncludeParam {
        Address(address::Include),
        Deposit(deposit::Include),
        Revenue(revenue::Include),
    ...
    #[macro_export]
    macro_rules ! _partial_unchecked_user { ($ struct_name : ident { $ ($ scalar_field : ident) + }) => { :: prisma_client_rust :: macros :: partial_unchecked ! { crate :: prisma :: user struct $ struct_name { # [serde (rename = "address")] pub address : String , # [serde (rename = "deposit")] pub deposit : f64 , # [serde (rename = "revenue")] pub revenue : f64 , # [serde (rename = "version")] pub version : i32 , # [serde (rename = "created_at")] pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , # [serde (rename = "updated_at")] pub updated_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > } [$ ($ scalar_field) , +] } } ; }
    ...
    pub enum SetParam {
        ...
        DivideDeposit(f64),
        SetRevenue(f64),
        IncrementRevenue(f64),
        DecrementRevenue(f64),
        MultiplyRevenue(f64),
        DivideRevenue(f64),
        SetVersion(i32),
    ...
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
            match param {
                ...
                UncheckedSetParam::Revenue(value) => Self::SetRevenue(value),
    ...
    pub enum OrderByParam {
        ...
        Revenue(::prisma_client_rust::Direction),
    ...
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                Self::Revenue(direction) => (
                    revenue::NAME.to_string(),
                    ::prisma_client_rust::PrismaValue::String(direction.to_string()),
                ),
    ...
    pub enum WhereParam {
        ...
        Revenue(_prisma::read_filters::FloatFilter),
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::Revenue(value) => (revenue::NAME, value.into()),
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![
                ...
                ::prisma_client_rust::sel(revenue::NAME),
...
pub mod user_transaction {
    ...
    pub mod recipient_address {
        ...
        pub const NAME: &str = "recipient_address";
        pub struct Set(pub String);
        impl From<Set> for SetParam {
            fn from(Set(v): Set) -> Self {
                Self::SetRecipientAddress(v)
            }
        }
        impl From<Set> for UncheckedSetParam {
            fn from(Set(v): Set) -> Self {
                Self::RecipientAddress(v)
            }
        }
        pub fn set<T: From<Set>>(value: String) -> T {
            Set(value).into()
        ...
        pub fn order(direction: ::prisma_client_rust::Direction) -> OrderByParam {
            OrderByParam::RecipientAddress(direction)
        }
        pub fn equals(value: String) -> WhereParam {
            WhereParam::RecipientAddress(_prisma::read_filters::StringFilter::Equals(value))
        }
        ::prisma_client_rust::scalar_where_param_fns!(
            _prisma::read_filters::StringFilter,
            RecipientAddress,
        ...
        impl Into<super::IncludeParam> for Include {
            fn into(self) -> super::IncludeParam {
                super::IncludeParam::RecipientAddress(self)
            }
        }
        impl Include {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
        ...
        impl Into<super::SelectParam> for Select {
            fn into(self) -> super::SelectParam {
                super::SelectParam::RecipientAddress(self)
            }
        }
        impl Select {
            pub fn to_selection(self) -> ::prisma_client_rust::Selection {
    ...
    pub fn create(
        ...
        (tx_id, recipient_address, amount, user, _params)
    }
    pub fn create_unchecked(
        tx_id: String,
        user_address: String,
    ...
    impl SelectParam {
        pub fn to_selection(self) -> ::prisma_client_rust::Selection {
            match self {
                ...
                Self::RecipientAddress(data) => data.to_selection(),
    ...
    #[macro_export]
    macro_rules ! _include_user_transaction { ($ (($ ($ func_arg : ident : $ func_arg_ty : ty) , +) =>) ? $ module_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { # [allow (warnings)] pub mod $ module_name { crate :: prisma :: user_transaction :: include ! (@ definitions ; $ module_name ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; use super :: * ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: user_transaction :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } pub fn include ($ ($ ($ func_arg : $ func_arg_ty) , +) ?) -> Selection { Selection ([crate :: prisma :: user_transaction :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: user_transaction :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } } ; ({ $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { { crate :: prisma :: user_transaction :: include ! (@ definitions ; ; $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) +) ; pub struct Selection (Vec < :: prisma_client_rust :: Selection >) ; impl :: prisma_client_rust :: IncludeType for Selection { type Data = Data ; type ModelData = crate :: prisma :: user_transaction :: Data ; fn to_selections (self) -> Vec < :: prisma_client_rust :: Selection > { self . 0 } } Selection ([crate :: prisma :: user_transaction :: include ! (@ selections_to_params ; : include { $ ($ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) + }) . into_iter () . map (| p | p . to_selection ()) . collect :: < Vec < _ >> () , < crate :: prisma :: user_transaction :: Types as :: prisma_client_rust :: ModelTypes > :: scalar_selections ()] . into_iter () . flatten () . collect :: < Vec < _ >> ()) } } ; (@ definitions ; $ ($ module_name : ident) ? ; $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) +) => { # [allow (warnings)] enum Fields { user } # [allow (warnings)] impl Fields { fn selections () { $ (let _ = Fields :: $ field ;) + } } # [allow (warnings)] # [derive (std :: fmt :: Debug , Clone)] pub struct Data { pub tx_id : String , pub user_address : String , pub recipient_address : String , pub amount : f64 , pub cert : Option < String > , pub verified : bool , pub finalized : bool , pub failed : bool , pub created_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , pub updated_at : :: prisma_client_rust :: chrono :: DateTime < :: prisma_client_rust :: chrono :: FixedOffset , > , $ (pub $ field : crate :: prisma :: user_transaction :: include ! (@ field_type ; $ field $ (: $ selection_mode { $ ($ selections) + }) ?) ,) + } impl :: serde :: Serialize for Data { fn serialize < S > (& self , serializer : S) -> Result < S :: Ok , S :: Error > where S : :: serde :: Serializer , { use :: serde :: ser :: SerializeStruct ; let mut state = serializer . serialize_struct ("Data" , [$ (stringify ! ($ field) ,) + stringify ! (tx_id) , stringify ! (user_address) , stringify ! (recipient_address) , stringify ! (amount) , stringify ! (cert) , stringify ! (verified) , stringify ! (finalized) , stringify ! (failed) , stringify ! (created_at) , stringify ! (updated_at)] . len ()) ? ; $ (state . serialize_field (crate :: prisma :: user_transaction :: $ field :: NAME , & self . $ field) ? ;) * state . serialize_field (crate :: prisma :: user_transaction :: tx_id :: NAME , & self . tx_id) ? ; state . serialize_field (crate :: prisma :: user_transaction :: user_address :: NAME , & self . user_address) ? ; state . serialize_field (crate :: prisma :: user_transaction :: recipient_address :: NAME , & self . recipient_address) ? ; state . serialize_field (crate :: prisma :: user_transaction :: amount :: NAME , & self . amount) ? ; state . serialize_field (crate :: prisma :: user_transaction :: cert :: NAME , & self . cert) ? ; state . serialize_field (crate :: prisma :: user_transaction :: verified :: NAME , & self . verified) ? ; state . serialize_field (crate :: prisma :: user_transaction :: finalized :: NAME , & self . finalized) ? ; state . serialize_field (crate :: prisma :: user_transaction :: failed :: NAME , & self . failed) ? ; state . serialize_field (crate :: prisma :: user_transaction :: created_at :: NAME , & self . created_at) ? ; state . serialize_field (crate :: prisma :: user_transaction :: updated_at :: NAME , & self . updated_at) ? ; state . end () } } impl < 'de > :: serde :: Deserialize < 'de > for Data { fn deserialize < D > (deserializer : D) -> Result < Self , D :: Error > where D : :: serde :: Deserializer < 'de > , { # [allow (warnings)] enum Field { $ ($ field) , + , tx_id , user_address , recipient_address , amount , cert , verified , finalized , failed , created_at , updated_at } impl < 'de > :: serde :: Deserialize < 'de > for Field { fn deserialize < D > (deserializer : D) -> Result < Field , D :: Error > where D : :: serde :: Deserializer < 'de > , { struct FieldVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for FieldVisitor { type Value = Field ; fn expecting (& self , formatter : & mut :: std :: fmt :: Formatter) -> :: std :: fmt :: Result { formatter . write_str (& [$ (crate :: prisma :: user_transaction :: $ field :: NAME) , + , crate :: prisma :: user_transaction :: tx_id :: NAME , crate :: prisma :: user_transaction :: user_address :: NAME , crate :: prisma :: user_transaction :: recipient_address :: NAME , crate :: prisma :: user_transaction :: amount :: NAME , crate :: prisma :: user_transaction :: cert :: NAME , crate :: prisma :: user_transaction :: verified :: NAME , crate :: prisma :: user_transaction :: finalized :: NAME , crate :: prisma :: user_transaction :: failed :: NAME , crate :: prisma :: user_transaction :: created_at :: NAME , crate :: prisma :: user_transaction :: updated_at :: NAME] . into_iter () . collect :: < Vec < _ >> () . join (", ")) } fn visit_str < E > (self , value : & str) -> Result < Field , E > where E : :: serde :: de :: Error , { match value { $ (crate :: prisma :: user_transaction :: $ field :: NAME => Ok (Field :: $ field)) , * , crate :: prisma :: user_transaction :: tx_id :: NAME => Ok (Field :: tx_id) , crate :: prisma :: user_transaction :: user_address :: NAME => Ok (Field :: user_address) , crate :: prisma :: user_transaction :: recipient_address :: NAME => Ok (Field :: recipient_address) , crate :: prisma :: user_transaction :: amount :: NAME => Ok (Field :: amount) , crate :: prisma :: user_transaction :: cert :: NAME => Ok (Field :: cert) , crate :: prisma :: user_transaction :: verified :: NAME => Ok (Field :: verified) , crate :: prisma :: user_transaction :: finalized :: NAME => Ok (Field :: finalized) , crate :: prisma :: user_transaction :: failed :: NAME => Ok (Field :: failed) , crate :: prisma :: user_transaction :: created_at :: NAME => Ok (Field :: created_at) , crate :: prisma :: user_transaction :: updated_at :: NAME => Ok (Field :: updated_at) , _ => Err (:: serde :: de :: Error :: unknown_field (value , FIELDS)) , } } } deserializer . deserialize_identifier (FieldVisitor) } } struct DataVisitor ; impl < 'de > :: serde :: de :: Visitor < 'de > for DataVisitor { type Value = Data ; fn expecting (& self , formatter : & mut std :: fmt :: Formatter) -> std :: fmt :: Result { formatter . write_str ("struct Data") } fn visit_map < V > (self , mut map : V) -> Result < Data , V :: Error > where V : :: serde :: de :: MapAccess < 'de > , { $ (let mut $ field = None ;) * let mut tx_id = None ; let mut user_address = None ; let mut recipient_address = None ; let mut amount = None ; let mut cert = None ; let mut verified = None ; let mut finalized = None ; let mut failed = None ; let mut created_at = None ; let mut updated_at = None ; while let Some (key) = map . next_key () ? { match key { Field :: tx_id => { if tx_id . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: tx_id :: NAME)) ; } tx_id = Some (map . next_value () ?) ; } Field :: user_address => { if user_address . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: user_address :: NAME)) ; } user_address = Some (map . next_value () ?) ; } Field :: recipient_address => { if recipient_address . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: recipient_address :: NAME)) ; } recipient_address = Some (map . next_value () ?) ; } Field :: amount => { if amount . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: amount :: NAME)) ; } amount = Some (map . next_value () ?) ; } Field :: cert => { if cert . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: cert :: NAME)) ; } cert = Some (map . next_value () ?) ; } Field :: verified => { if verified . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: verified :: NAME)) ; } verified = Some (map . next_value () ?) ; } Field :: finalized => { if finalized . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: finalized :: NAME)) ; } finalized = Some (map . next_value () ?) ; } Field :: failed => { if failed . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: failed :: NAME)) ; } failed = Some (map . next_value () ?) ; } Field :: created_at => { if created_at . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: created_at :: NAME)) ; } created_at = Some (map . next_value () ?) ; } Field :: updated_at => { if updated_at . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: updated_at :: NAME)) ; } updated_at = Some (map . next_value () ?) ; } $ (Field :: $ field => { if $ field . is_some () { return Err (:: serde :: de :: Error :: duplicate_field (crate :: prisma :: user_transaction :: $ field :: NAME)) ; } $ field = Some (map . next_value () ?) ; }) * } } $ (let $ field = $ field . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: $ field :: NAME)) ? ;) * let tx_id = tx_id . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: tx_id :: NAME)) ? ; let user_address = user_address . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: user_address :: NAME)) ? ; let recipient_address = recipient_address . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: recipient_address :: NAME)) ? ; let amount = amount . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: amount :: NAME)) ? ; let cert = cert . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: cert :: NAME)) ? ; let verified = verified . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: verified :: NAME)) ? ; let finalized = finalized . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: finalized :: NAME)) ? ; let failed = failed . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: failed :: NAME)) ? ; let created_at = created_at . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: created_at :: NAME)) ? ; let updated_at = updated_at . ok_or_else (|| serde :: de :: Error :: missing_field (crate :: prisma :: user_transaction :: updated_at :: NAME)) ? ; Ok (Data { tx_id , user_address , recipient_address , amount , cert , verified , finalized , failed , created_at , updated_at , $ ($ field) , * }) } } const FIELDS : & 'static [& 'static str] = & ["tx_id" , "user_address" , "recipient_address" , "amount" , "cert" , "verified" , "finalized" , "failed" , "created_at" , "updated_at" , "user"] ; deserializer . deserialize_struct ("Data" , FIELDS , DataVisitor) } } $ ($ (pub mod $ field { crate :: prisma :: user_transaction :: $ selection_mode ! (@ field_module ; $ field : $ selection_mode { $ ($ selections) + }) ; }) ?) + } ; (@ field_type ; user : $ selection_mode : ident { $ ($ selections : tt) + }) => { user :: Data } ; (@ field_type ; user) => { crate :: prisma :: user :: Data } ; (@ field_type ; $ field : ident $ ($ tokens : tt) *) => { compile_error ! (stringify ! (Cannot include nonexistent relation $ field on model "UserTransaction" , available relations are "user")) } ; (@ field_module ; user : $ selection_mode : ident { $ ($ selections : tt) + }) => { crate :: prisma :: user :: include ! (@ definitions ; ; $ ($ selections) +) ; } ; (@ field_module ; $ ($ tokens : tt) *) => { } ; (@ selection_field_to_selection_param ; user $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? : $ selection_mode : ident { $ ($ selections : tt) + }) => { { Into :: < crate :: prisma :: user_transaction :: IncludeParam > :: into (crate :: prisma :: user_transaction :: user :: Include :: $ selection_mode (crate :: prisma :: user :: select ! (@ selections_to_params ; : $ selection_mode { $ ($ selections) + }) . into_iter () . collect ())) } } ; (@ selection_field_to_selection_param ; user $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ?) => { { Into :: < crate :: prisma :: user_transaction :: IncludeParam > :: into (crate :: prisma :: user_transaction :: user :: Include :: Fetch) } } ; (@ selection_field_to_selection_param ; $ ($ tokens : tt) *) => { compile_error ! (stringify ! ($ ($ tokens) *)) } ; (@ selections_to_params ; : $ macro_name : ident { $ ($ field : ident $ (($ ($ filters : tt) +) $ (. $ arg : ident ($ ($ arg_params : tt) *)) *) ? $ (: $ selection_mode : ident { $ ($ selections : tt) + }) ?) + }) => { [$ (crate :: prisma :: user_transaction :: $ macro_name ! (@ selection_field_to_selection_param ; $ field $ (($ ($ filters) +) $ (. $ arg ($ ($ arg_params) *)) *) ? $ (: $ selection_mode { $ ($ selections) + }) ?) ,) +] } ; (@ filters_to_args ;) => { vec ! [] } ; (@ filters_to_args ; $ ($ t : tt) *) => { $ ($ t) * } ; (@ field_serde_name ; tx_id) => { "tx_id" } ; (@ field_serde_name ; user_address) => { "user_address" } ; (@ field_serde_name ; recipient_address) => { "recipient_address" } ; (@ field_serde_name ; amount) => { "amount" } ; (@ field_serde_name ; cert) => { "cert" } ; (@ field_serde_name ; verified) => { "verified" } ; (@ field_serde_name ; finalized) => { "finalized" } ; (@ field_serde_name ; failed) => { "failed" } ; (@ field_serde_name ; created_at) => { "created_at" } ; (@ field_serde_name ; updated_at) => { "updated_at" } ; (@ field_serde_name ; user) => { "user" } ; }
    pub use _include_user_transaction as include;
    pub enum IncludeParam {
        TxId(tx_id::Include),
        UserAddress(user_address::Include),
        RecipientAddress(recipient_address::Include),
    ...
    impl From<UncheckedSetParam> for SetParam {
        fn from(param: UncheckedSetParam) -> Self {
            match param {
                ...
                UncheckedSetParam::RecipientAddress(value) => Self::SetRecipientAddress(value),
    ...
    pub enum OrderByParam {
        ...
        RecipientAddress(::prisma_client_rust::Direction),
    ...
    impl Into<(String, ::prisma_client_rust::PrismaValue)> for OrderByParam {
        fn into(self) -> (String, ::prisma_client_rust::PrismaValue) {
            match self {
                ...
                Self::RecipientAddress(direction) => (
                    recipient_address::NAME.to_string(),
                    ::prisma_client_rust::PrismaValue::String(direction.to_string()),
                ),
    ...
    pub enum WhereParam {
        ...
        RecipientAddress(_prisma::read_filters::StringFilter),
    ...
    impl ::prisma_client_rust::WhereInput for WhereParam {
        fn serialize(self) -> ::prisma_client_rust::SerializedWhereInput {
            let (name, value) = match self {
                ...
                Self::RecipientAddress(value) => (recipient_address::NAME, value.into()),
    ...
    impl ::prisma_client_rust::ModelTypes for Types {
        ...
        fn scalar_selections() -> Vec<::prisma_client_rust::Selection> {
            vec![
                ...
                ::prisma_client_rust::sel(recipient_address::NAME),
    ...
    impl<'a> Actions<'a> {
        ...
        pub fn create_many(
            ...
            let data = data
                .into_iter()
                .map(
                    |(tx_id, user_address, recipient_address, amount, mut _params)| {
                        _params.extend([
                            tx_id::set(tx_id),
                            user_address::set(user_address),
                            recipient_address::set(recipient_address),
        ...
        pub fn upsert(
            self,
            _where: UniqueWhereParam,
            (tx_id, recipient_address, amount, user, mut _params): (
                String,
                String,
                f64,
                super::user::UniqueWhereParam,
    ...
    impl ToString for UserTransactionScalarFieldEnum {
        fn to_string(&self) -> String {
            match self {
                ...
                Self::RecipientAddress => "recipient_address".to_string(),
