...
import {ServiceManager4Mica} from "../../../src/ServiceManager4Mica.sol";
...
library SetupPaymentsLib {
    ...
    function createOperatorDirectedAVSRewardsSubmissions(
        ...
        ServiceManager4Mica(avs).createOperatorDirectedAVSRewardsSubmission(operatorDirectedRewardsSubmissions);
    }
