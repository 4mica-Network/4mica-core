...
import {FourMicaServiceManager} from "../src/FourMicaServiceManager.sol";
...
contract FourMicaServiceManagerSetup is Test {
    ...
    FourMicaDeploymentLib.DeploymentData internal fourMicaDeployment;
    ...
    function setUp() public virtual {
        ...
        fourMicaDeployment = FourMicaDeploymentLib.deployContracts(
    ...
    function labelContracts() internal {
        ...
        vm.label(fourMicaDeployment.fourMicaServiceManager, "FourMicaServiceManager");
        vm.label(fourMicaDeployment.stakeRegistry, "StakeRegistry");
    }
}
