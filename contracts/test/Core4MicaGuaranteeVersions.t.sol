...
contract MockGuaranteeDecoder is IGuaranteeDecoder {
    ...
    function decode(bytes calldata data) external pure override returns (Guarantee memory) {
...
contract Core4MicaGuaranteeVersionsTest is Core4MicaTestBase {
    ...
    bytes32 internal constant TEST_PRIVATE_KEY_V2 =
        bytes32(0x9373427D6A25FD7C4CD1D286B1E9630FF4F95C5A625CB9974630FA2B5311AEE3);
    ...
    function test_configureGuaranteeVersion_setsAndUsesNewVersion() public {
        ...
        MockGuaranteeDecoder.GuaranteeV2 memory g2 =
            _guaranteeV2(domainV2, 101, 11, USER1, USER2, 500 ether, address(usdc), uint64(block.timestamp), 2);
    ...
    function _signGuaranteeV2(MockGuaranteeDecoder.GuaranteeV2 memory g, bytes32 privKey)
        internal
        view
