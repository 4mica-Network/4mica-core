...
contract MainnetFourMicaDeployer is Script {
    ...
    function run() external {
        ...
        MainnetISDeploymentLib.FourMicaSetupConfig memory isConfig =
            MainnetISDeploymentLib.readFourMicaConfigJson("mainnet_config");
        ...
        fourMicaStrategy = IStrategy(MainnetCoreLib.ST_ETH_STRATEGY_ADDRESS);
